            ...
            <div class="well">
                <form action="" method="post" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" name="apikey" id="apikey" value="<?=$_POST['apikey'];?>" placeholder="Enter API Key">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="email">Email Address (associated with the API Key)</label>
                        <div class="col-lg-10">
                            <input type="email" class="form-control" name="email" id="email" value="<?=$_POST['email'];?>" placeholder="Enter email">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            ...
                            <textarea class="form-control" id="ips" name ="ips" rows="10" placeholder="List of IPv4 addresses, 1 per line"><?=$_POST['ips'];?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select name="act" id="act" class="form-control">
                                ...
                                <option <?php if($_POST['act']=='wl') echo 'selected=selected';?> value="wl">WhiteList</option>
                                <option <?php if($_POST['act']=='ban') echo 'selected=selected';?> value="ban">BlackList</option>
                                <option <?php if($_POST['act']=='nul') echo 'selected=selected';?> value="nul">Remove</option>
                            </select>
                        </div>
                    </div>
